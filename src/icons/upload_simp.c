...
#ifndef LV_ATTRIBUTE_IMG_UPLOAD_SIMP
#define LV_ATTRIBUTE_IMG_UPLOAD_SIMP
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_UPLOAD_SIMP uint8_t upload_simp_map[] = {
...
const lv_img_dsc_t upload_simp = {
