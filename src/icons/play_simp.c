...
#ifndef LV_ATTRIBUTE_IMG_PLAY_SIMP
#define LV_ATTRIBUTE_IMG_PLAY_SIMP
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_PLAY_SIMP uint8_t play_simp_map[] = {
