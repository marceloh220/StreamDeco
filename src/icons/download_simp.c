...
#ifndef LV_ATTRIBUTE_IMG_DOWNLOAD_SIMP
#define LV_ATTRIBUTE_IMG_DOWNLOAD_SIMP
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_DOWNLOAD_SIMP uint8_t download_simp_map[] = {
...
const lv_img_dsc_t download_simp = {
