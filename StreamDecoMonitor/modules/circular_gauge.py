...
class CircularGauge(ctk.CTkFrame):
    """A custom circular gauge widget for displaying percentage values."""

    def __init__(self, master, size: int = 92, thickness: int = 12, **kwargs):
        """Initialize the circular gauge widget.
        
        Args:
            master: The parent widget.
            size (int): The size of the gauge.
            thickness (int): The thickness of the gauge arc.
        """
    ...
    def set_value(self, value: float) -> None:
        ...
        Args:
            value (float): The new value for the gauge (0-100).
        """
