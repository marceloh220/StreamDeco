...
typedef enum {
  ESP32RGBPanel_ROTATION_NORMAL,
  ESP32RGBPanel_ROTATION_LANDSCAPE = ESP32RGBPanel_ROTATION_NORMAL,
  ESP32RGBPanel_ROTATION_PORTTRAIL,
  ESP32RGBPanel_ROTATION_LANDSCAPE_MIRROR,
  ESP32RGBPanel_ROTATION_PORTTRAIL_MIRROR,
} ESP32RGBPanel_rotation_t;
...
public:
  ...
  uint16_t *getFrameBuffer(
      ...
      void rotate(ESP32RGBPanel_rotation_t);
