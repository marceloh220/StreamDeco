...
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "lvgl_port_tick.h"            /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (lvgl_tick_millis())    /*Expression evaluating to current system time in ms*/
